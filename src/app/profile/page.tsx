...
export default function Profile() {
  ...
  return (
    <div className="relative overflow-x-hidden min-h-screen -mx-4 lg:-mx-8 -my-6 lg:-my-10 px-4 lg:px-8 py-6 lg:py-10 transition-colors duration-300 bg-slate-50 dark:bg-[#0B0C10]">
